...
public class SwerveModule extends SubsystemBase {
  ...
  public void setDesiredState (SwerveModuleState state) {
    ...
    SmartDashboard.putNumber("help me", state.speedMetersPerSecond);
  ...
  public SwerveModulePosition getSMPosition(){
    return new SwerveModulePosition(getDrivePosition(), Rotation2d.fromRadians(getHeadingRadians()));
  }
  //lol we screwed up here
